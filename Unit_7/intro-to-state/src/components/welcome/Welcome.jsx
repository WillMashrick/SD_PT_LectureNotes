export default function Welcome(props) {
  ...
  function removeName() {
    ...
    // Next we want to target our setName prop (fuction) and pass our new array as the updated value for our state variable. AKA we will reset the names array to the updatedNames filtered array.
