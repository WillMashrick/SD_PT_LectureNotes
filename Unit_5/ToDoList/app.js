// Access Express and its methods; we can do that via require()
...
// call on our app var, use the .use() to tell our app: express.json() (use JSON please express)
...
// __dirname comes from node (it's accessible whenever using node)
...
// Building route to aut controller: http://localhost:4000/todo
app.use("/todo", auth);

// Route to routes controller: ttp://localhost:4000/routes
...
// First call our app var, use the .listen method, pass that method the port var and create a CB function to give us some feedback(console.log) to affirm it's running
app.listen(PORT, () => {
