...
// console.log(form); // We are able to access our various inputs baded off the "name" we assigned them
...
form.addEventListener("submit", (event) => {
    ...
    event.preventDefault(); // stops the default refresh
...
// console.log(animal); error animal is not global
