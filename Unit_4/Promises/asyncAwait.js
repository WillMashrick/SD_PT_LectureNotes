...
// Async Function Declaration (declarative syle)
...
/*
? Await
    - Tells JS that a promise is being returned and wait on that result.
*/
...
extraData().then((data) => console.log("Line 53 return of AsyncAwait.js:", data));
