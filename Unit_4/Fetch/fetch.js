...
function seeDogPic(jsonDataFromFetch) {
  log("In the seeDogPic Func", jsonDataFromFetch);

  // Create elements
  let img = document.createElement("img");

  // Assign the img attributes
...
// getCatFact(); // The world's largest cat measured 48.5 inches long.
...
getCatFact2(); // Print fact to the console
