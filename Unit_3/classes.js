...
/* 
    ...
    3. Constructor keyword. This is activated we we instantiate a new object. Builds what sort of keys and values will be associated with our new object. 
...
class Expense {
    ...
    static addUpchargeForProfit(wholesale) {
        ...
        // return (so it's accessable) the new expense
