...
// Create a findIt function that will use whatever object(dict) and key term(search) given and return the value result if found
...
const kidFeelsTable = {
    Hungry: "THE KID WANTS FOOD, WHERE'S THE SNACKS!?!",
...
function enterState(newState) {
    ...
    if (validTransitions.includes(newState)) {
        // Allow our state to change to true to next state 
