...
router.post("/login", async (req, res) => {
  ...
  try {
    ...
    // * .findOne() A MongoDB method that accepts a query as an argument. Returns an instance of a document that matches.
    ...
    // Write an error to catch if no user matches, quick response if now user in DB
